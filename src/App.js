...
const ADMIN_INVENTORY  = ["ADMIN","INVENTORY_MANAGER","STORE_MANAGER"];
const ADMIN_FINANCE    = ["ADMIN","FINANCE_OFFICER"];
const ADMIN_COMPLIANCE = ["ADMIN","COMPLIANCE_OFFICER","STORE_MANAGER"];
    ...
    return (
        <Router>
            <Routes>
                ...
                {/* Audit Log — ADMIN + COMPLIANCE_OFFICER + STORE_MANAGER */}
                ...
                {/* Inventory — ADMIN + INVENTORY_MANAGER + STORE_MANAGER */}
                ...
                {/* Compliance — ADMIN + COMPLIANCE_OFFICER + STORE_MANAGER */}
