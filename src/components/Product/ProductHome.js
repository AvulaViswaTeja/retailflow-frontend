...
const NAV_ITEMS = [
    { label: 'Add Product',            to: 'add',                    icon: 'ti-plus'        },
    { label: 'Delete Product',         to: 'delete',                 icon: 'ti-trash'       },
    { label: 'Update Product',         to: 'update',                 icon: 'ti-edit'        },
    { label: 'Get By ID',              to: 'getById',                icon: 'ti-search'      },
    { label: 'Get By Category',        to: 'getProductsByCategory',  icon: 'ti-tag'         },
    { label: 'All Products',           to: 'getAll',                 icon: 'ti-list'        },
    { label: 'All Products Paginated', to: 'getAllProductsPaginated', icon: 'ti-layout-rows' },
];

export default function ProductHome() {
    const navigate = useNavigate();
    const location = useLocation();
    const isHome = location.pathname.replace(/\/$/, '') === '/Product';
            ...
            <nav style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 11, fontSize: 16, fontWeight: 500, color: '#fff' }}>
                    <div style={{
                        ...
                        <i className="ti ti-box" style={{ fontSize: 18 }}></i>
                    </div>
                    Products
                </div>
                    ...
                    <>
                        ...
                        <div style={{
                            ...
                            <p style={{ fontSize: 13, color: 'rgba(255,255,255,.8)', position: 'relative', zIndex: 1 }}>
                                Manage your products — add, update, delete and search with ease
                            </p>
                        </div>
