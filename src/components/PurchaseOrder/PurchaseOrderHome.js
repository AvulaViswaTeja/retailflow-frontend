...
const NAV_ITEMS = [
    { label: 'Insert Purchase Order',  to: 'insert',           icon: 'ti-plus'         },
    { label: 'Get Purchase Order',     to: 'getById',          icon: 'ti-search'       },
    { label: 'Get All Orders',         to: 'getAll',           icon: 'ti-list'         },
    { label: 'Get By Supplier',        to: 'getBySupplier',    icon: 'ti-building'     },
    { label: 'Get By Status',          to: 'getByStatus',      icon: 'ti-filter'       },
    { label: 'All Orders Paginated',   to: 'getallpaginated',  icon: 'ti-layout-rows'  },
];

export default function PurchaseOrderHome() {
    const navigate = useNavigate();
    const location = useLocation();
    const isHome = location.pathname.replace(/\/$/, '') === '/PurchaseOrder';
                    ...
                    <>
                        ...
                        <div style={{
                            ...
                            <p style={{ fontSize: 13, color: 'rgba(255,255,255,.8)', position: 'relative', zIndex: 1 }}>
                                Manage your purchase orders — create, update, track and monitor order statuses with ease
                            </p>
                        </div>
