...
const THRESHOLD_CARDS = [
    {
        ...
        hint: 'How fast inventory is sold',
    },
    {
        label: 'Sales Growth',
        value: '≥ 0%',
        ...
        grad: GRAD.green,
        icon: 'ti-trending-up',
        hint: 'Period over period growth',
    },
    {
        ...
        grad: GRAD.red,
        icon: 'ti-package',
        hint: 'Lost or damaged inventory',
    },
];
                ...
                {isHome ? (
                    <>
                        ...
                        <div style={{
                            ...
                            padding: '28px 30px',
                            borderRadius: 18,
                            background: 'linear-gradient(120deg,#064e3b 0%,#065f46 55%,#0d9488 100%)',
                            ...
                            <p style={{ fontSize: 13, color: 'rgba(255,255,255,.8)', position: 'relative', zIndex: 1 }}>
                                Monitor KPI thresholds, generate compliance verdicts and track regulatory reports
                            </p>
